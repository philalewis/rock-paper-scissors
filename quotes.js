var quoteOptions = {
  ...
  kierkegaardGood: [`Soren Kierkegaard says, `, `"Life can only be understood backwards; but it must be lived forwards."`],
  kierkegaardBad: [`Soren Kierkegaard says, `, `"People demand freedom of speech as a compensation for the freedom of thought which they seldom use."`],
  kierkegaardTie: [`Soren Kierkegaard says, `, `"There are two ways to be fooled. One is to believe what isn't true; the other is to refuse to believe what is true."`],
